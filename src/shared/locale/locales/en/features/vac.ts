...
export const vac = {
  ...
  "user-response.members_moved":
    "Moved to {{channel}}.",
  "user-response.panel_refreshed":
  ...
  "user-response.category_full":
    "The category has reached the channel limit.",
  ...
  // ── embed: remove_error ────────────────────────
  "embed.title.remove_error":
    "Removal Error",

  // ── embed: config_view ─────────────────────────
  "embed.title.config_view":
    "Voice Auto-Create",
  "embed.field.name.trigger_channels":
    "Trigger channels",
  "embed.field.name.created_vcs":
    "Created VC count",
  "embed.field.name.created_vc_details":
    "Created VCs",
  "embed.field.value.not_configured":
    "Not configured",
  "embed.field.value.no_created_vcs":
    "None",
  ...
  "log.channel_delete_sync_failed":
    "Failed to sync config on channelDelete",
  "log.panel_send_failed":
    "Failed to send control panel",
  "log.startup_cleanup_failed":
