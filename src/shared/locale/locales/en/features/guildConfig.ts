...
export const guildConfig = {
  ...
  "guild-config.import.description":
    "Import guild settings from JSON file",
  ...
  "user-response.reset_success":
    "Guild settings have been reset.",
  "user-response.reset_cancelled":
    "Reset has been cancelled.",
  "user-response.reset_all_success":
    "All feature settings have been reset.",
  "user-response.reset_all_cancelled":
    "Reset has been cancelled.",
  "user-response.export_success":
    "Guild settings have been exported.",
  "user-response.export_empty":
    "No settings to export.",
  "user-response.import_success":
    "Guild settings have been imported.",
  "user-response.import_cancelled":
  ...
  "embed.title.view":
    "🛡️ Guild Settings",
  "embed.field.name.locale":
    "Language",
  "embed.field.name.error_channel":
  ...
  "ui.select.view_placeholder":
    "Select a page...",
  "ui.select.guild_config":
    "Guild Settings",
  "ui.select.afk":
    "AFK",
  "ui.select.vac":
    "VAC",
  "ui.select.vc_recruit":
    "VC Recruit",
  "ui.select.sticky":
    "Sticky Message",
  "ui.select.member_log":
    "Member Log",
  "ui.select.bump":
    "Bump Reminder",
  ...
  "ui.button.reset_cancel":
    "Cancel",
  "ui.button.reset_all_confirm":
    "Reset",
  "ui.button.reset_all_cancel":
    "Cancel",
  "ui.button.import_confirm":
    "Import",
  "ui.button.import_cancel":
    "Cancel",

  // ── Logs ──────────────────────────────────────
  "log.locale_set":
    "Language set GuildId: {{guildId}} Locale: {{locale}}",
  "log.error_channel_set":
    "Error channel set GuildId: {{guildId}} ChannelId: {{channelId}}",
  "log.reset":
    "Guild settings reset GuildId: {{guildId}}",
  "log.reset_all":
    "All settings reset GuildId: {{guildId}}",
  "log.exported":
    "Guild settings exported GuildId: {{guildId}}",
  "log.imported":
    "Guild settings imported GuildId: {{guildId}}",
} as const;
