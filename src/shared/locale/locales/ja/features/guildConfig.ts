...
export const guildConfig = {
  ...
  // ── ログ ──────────────────────────────────────
  "log.locale_set":
    "言語設定 GuildId: {{guildId}} Locale: {{locale}}",
  "log.error_channel_set":
    "エラー通知チャンネル設定 GuildId: {{guildId}} ChannelId: {{channelId}}",
  "log.reset":
    "ギルド設定リセット GuildId: {{guildId}}",
  "log.reset_all":
    "全設定リセット GuildId: {{guildId}}",
  "log.exported":
    "ギルド設定エクスポート GuildId: {{guildId}}",
  "log.imported":
    "ギルド設定インポート GuildId: {{guildId}}",
} as const;
