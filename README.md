...
> サーバーに彩りを加え、豊かで快適なコミュニティを実現する使いやすさ重視の多機能 Discord Bot

**開発開始**: 2026年2月 | **最終更新**: 2026年3月29日 | **AI利用**: コードおよびドキュメントの作成に生成AIを使用しています。
...
| Web UI           | ブラウザからBot設定を管理するダッシュボード               |  📋  | [spec](docs/specs/WEB_UI_SPEC.md)         | —                                                         |
...
- [Web UIダッシュボード](docs/specs/WEB_UI_SPEC.md) - ブラウザからBot設定を管理するダッシュボード（[モック](docs/mockups/)）
