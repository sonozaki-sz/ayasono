...
<tr><th align="left" colspan="2">🔧 ギルド設定 概要</th></tr>
<tr><td>言語</td><td>日本語 (ja)</td></tr>
<tr><th align="left" colspan="2">機能状態</th></tr>
<tr><td>👋 メンバーログ</td><td>❌ 無効</td></tr>
<tr><td>🔔 Bumpリマインダー</td><td>✅ 有効</td></tr>
<tr><td>📌 メッセージ固定</td><td>✅ 有効（3件）</td></tr>
<tr><td>⚙️ VAC</td><td>✅ 有効</td></tr>
<tr><td>🎤 VC募集</td><td>❌ 無効</td></tr>
<tr><td>😴 AFK</td><td>❌ 無効</td></tr>
<tr><td>🗑️ メッセージ削除</td><td>─（常時利用可）</td></tr>
<tr><td colspan="2" align="right"><i>🔧 ギルド設定 概要 • 1 / 8</i></td></tr>
</table>

<kbd>◀ 前へ</kbd> &nbsp; <kbd>次へ ▶</kbd> &nbsp; <kbd>ページを選択... ▼</kbd>
...
<tr><th align="left">⚠️ ギルド設定をリセットしますか？</th></tr>
<tr><td>
以下の設定がすべて削除されます。この操作は元に戻せません。<br><br>
• 言語設定<br>
• VAC 設定<br>
• VC募集設定<br>
• メッセージ固定設定（全チャンネル）<br>
